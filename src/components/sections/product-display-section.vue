...
<template>
  <section
    ...
    class="md:content-grid mx-auto w-full max-w-[calc(32rem+2rem)] space-y-4 md:space-y-6 lg:space-y-8"
  >
    <ProductImageCarousel>
      <figure
        class="bg-orange relative grid aspect-square cursor-pointer place-content-center overflow-hidden sm:rounded-2xl"
      >
        <img
          ref="imageRef"
